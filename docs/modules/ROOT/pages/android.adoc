...
To do this, you should follow the instructions to https://docs.unity3d.com/Manual/overriding-android-manifest.html[Create a template Unity Library Manifest file] in the Unity documentation.
