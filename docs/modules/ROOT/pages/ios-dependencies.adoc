...
IMPORTANT: If you are using the 'xref:quickstart/install-sdk.adoc#_configure_teak_in_the_unity_editor[Build Post-Processing,window=_blank]' option, you can skip all of these steps. The build post-process scripts in the Teak Unity SDK will manage all of this for you.
...
NOTE: These should be present as dependencies on Teak.xcframework (as specified in Teak.xcframework.meta),
