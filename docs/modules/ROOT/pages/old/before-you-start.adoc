...
Follow these instructions to get your Server Key and Sender ID (xref:usage:reference:page$firebase-fcm.adoc[Finding your Android Push Credentials on Firebase, window=_blank]).
