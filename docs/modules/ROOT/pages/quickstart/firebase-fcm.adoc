...
You may need to update your link:https://docs.unity3d.com/Manual/overriding-android-manifest.html#creating-a-template-android-manifest-file[Custom Main Manifest] to xref:android-push-broken.adoc[remove an entry added by the Firebase Unity SDK].
====
