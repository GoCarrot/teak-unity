...
Your initial Teak integration is done. Teak is setup to collect data which your CRMs will use to xref:user-guide::page$notifications.adoc[create and send notifications] to specific xref:user-guide::page$audiences.adoc[audiences].
