...
Congratulations, you've sent your first push notification using Teak! Your initial Teak integration is done. 

You _could_ ship this, and your game will start collecting data, and your CRMs can start creating and sending notifications to specific audiences. 

But, you aren't ready to stop, you are on a roll. So...

== Next Steps

Here are some features you can enable next:
