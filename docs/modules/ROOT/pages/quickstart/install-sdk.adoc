...
----
+
TIP: For reproducible builds, pin to a specific version by appending `#<version>` to the URL, e.g. `\https://github.com/GoCarrot/upm-package-teak.git#4.3.9`. See xref:upm.adoc[Unity Package Manager] for all version pinning options.
