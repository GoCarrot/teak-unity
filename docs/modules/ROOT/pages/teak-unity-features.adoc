...
TIP: For the marketing team to use Deep Links, they will have to xref:usage::page$notifications.adoc#_ios_deep_link["add the URL to their notifications", window=_blank] in the dashboard. So, keep a master list of active deep links that can be shared with your team, so everyone knows what is available for use.
