...
Follow these instructions to get the credentials for sending push notifications on Amazon devices xref:user-guide:reference:page$amazon-device-messaging.adoc[Finding your Amazon Device Messaging Credentials].
